(function (factory) {
	...
	if (typeof module === "object" && typeof module.exports === "object") {
		...
		//   require("jquery-simple-timer")(jQuery);
	...
	Timer.prototype.start = function (options) {
		...
		this.targetElement.each(
			function (_index, timerBox) {
				var that = this;
				var timerBoxElement = jQuery(timerBox);
	 ...
	 * jQuerytimerBox {jQuery object} - The timer element
	 * options {object} - The options for the timer
	 * css - The original css of the element
	 */
	Timer.prototype.resetTimer = function (jQuerytimerBox, options, css) {
		var interval = 0;
		if (options.loopInterval) {
			interval = parseInt(options.loopInterval, 10) * 1000;
		}
		setTimeout(function () {
			jQuerytimerBox.trigger("reset");
			jQuerytimerBox.attr("class", css + " loop");
			timer.startCountdown(jQuerytimerBox, options);
		}, interval);
	};
	...
	jQuery.fn.startTimer = function (options) {
